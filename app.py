...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Luyến - Trường  Tiểu học Minh Dân - ĐT: 0852246559</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Luyến - Trường  Tiểu học Minh Dân - ĐT: 0852246559</div>", unsafe_allow_html=True)
